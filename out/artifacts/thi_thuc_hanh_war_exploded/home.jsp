            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td > <a href="/product-controller?action=edit-product&product-id=${product.product_id}" class="btn btn-primary">Edit</a>  | <a href="/product-controller?action=delete-product&product-id=${product.product_id}" class="btn btn-danger">Delete</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
